...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/generated/guardstone-logo.png" },
      { name: "twitter:image", content: "/generated/guardstone-logo.png" },
    ],
    links: [
      { rel: "icon", type: "image/png", href: "/generated/guardstone-logo.png" },
      { rel: "apple-touch-icon", href: "/generated/guardstone-logo.png" },
    ],
  }),
  component: Index,
});
