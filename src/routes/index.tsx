...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/generated/brand-logo.png" },
      { name: "twitter:image", content: "/generated/brand-logo.png" },
    ],
    links: [
      { rel: "icon", type: "image/png", href: "/generated/brand-logo.png" },
      { rel: "apple-touch-icon", href: "/generated/brand-logo.png" },
    ],
  }),
  component: Index,
});
