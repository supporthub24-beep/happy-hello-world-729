...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/generated/5731b571-50b-download.png" },
      { name: "twitter:image", content: "/generated/5731b571-50b-download.png" },
    ],
    links: [
      { rel: "icon", type: "image/png", href: "/generated/5731b571-50b-download.png" },
      { rel: "apple-touch-icon", href: "/generated/5731b571-50b-download.png" },
    ],
  }),
  component: Index,
});
